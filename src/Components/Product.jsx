...
function Product({ post }) {
  ...
  return (
    <div className='flex flex-col items-center justify-between hover:scale-110 gap-3 p-4 mt-10 ml-5 rounded-xl outline transition duration-300 ease-in'>
      <div className='text-gray-700 font-semibold text-lg mt-1 truncate w-40 '>
        <p>{post.title}</p>
      </div>
